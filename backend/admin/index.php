    ...
    <div class="container mt-5">
        ...
        <div class="stats-container">
            <div class="row g-4">
                <?php
                $stat_cards = [
                    ['title' => 'Total Incoming', 'value' => $stats['total_incoming_files'], 'icon' => 'fas fa-file-import', 'color' => 'text-primary'],
                    ['title' => 'Total Outgoing', 'value' => $stats['total_outgoing_files'], 'icon' => 'fas fa-file-export', 'color' => 'text-success'],
                    ['title' => 'Month (Incoming)', 'value' => $stats['incoming_this_month'], 'icon' => 'fas fa-calendar-alt', 'color' => 'text-info'],
                    ['title' => 'Month (Outgoing)', 'value' => $stats['outgoing_this_month'], 'icon' => 'fas fa-calendar-check', 'color' => 'text-warning'],
                    ['title' => 'Week (Incoming)', 'value' => $stats['incoming_this_week'], 'icon' => 'fas fa-calendar-week', 'color' => 'text-danger'],
                    ['title' => 'Week (Outgoing)', 'value' => $stats['outgoing_this_week'], 'icon' => 'fas fa-calendar-week', 'color' => 'text-secondary'],
